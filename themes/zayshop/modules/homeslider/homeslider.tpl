...
<!-- Module HomeSlider -->
    {if isset($homeslider_slides)}
		<div id="homepage-slider"  style="">
			...
			<ul id="homeslider"{if isset($smarty.capture.height) && $smarty.capture.height} {/if}>
					...
					{if $slide.active}
						<li class="homeslider-container" style="width: 1850px !important; border: 1px solid red;background-color: red;">
							...
							{if isset($slide.description) && trim($slide.description) != ''}
								<div style="position: absolute;top: 0; left: 0;" class="homeslider-description">{$slide.description}</div>
							{/if}
						</li>
					{/if}
				{/foreach}
    ...
    {if isset($homeslider_slides)}
		<div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner" {if isset($smarty.capture.height) && $smarty.capture.height} style="max-height:{$smarty.capture.height}px;"{/if}>
				{foreach from=$homeslider_slides item=slide}
					{if $slide.active}
						<div class="carousel-item active homeslider-container">
			                <div class="container">
			                    <div class="row p-5">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./themes/zayshop/img/banner_img_01.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Zay</b> eCommerce</h1>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./themes/zayshop/img/banner_img_02.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./themes/zayshop/img/banner_img_03.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
