	...
	<div class="col-md-4 pt-5">
		...
		<ul class="list-unstyled text-light footer-link-list">
			{if isset($show_price_drop) && $show_price_drop && !$PS_CATALOG_MODE}
				<li>
					<a class="text-decoration-none" href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='Specials' mod='blockcms'}">
			...
			<li>
				<a class="text-decoration-none" href="{$link->getPageLink('new-products')|escape:'html':'UTF-8'}" title="{l s='New products' mod='blockcms'}">
			...
			{if isset($show_best_sales) && $show_best_sales && !$PS_CATALOG_MODE}
				<li>
					<a class="text-decoration-none" href="{$link->getPageLink('best-sales')|escape:'html':'UTF-8'}" title="{l s='Top sellers' mod='blockcms'}">
			...
			{if isset($display_stores_footer) && $display_stores_footer}
				<li>
					<a class="text-decoration-none" href="{$link->getPageLink('stores')|escape:'html':'UTF-8'}" title="{l s='Our stores' mod='blockcms'}">
						{l s='Our stores' mod='blockcms'}
					</a>
				</li>
			{/if}
			...
			<li>
				<a class="text-decoration-none" href="{$link->getPageLink($contact_url, true)|escape:'html':'UTF-8'}" title="{l s='Contact us' mod='blockcms'}">
			...
			{foreach from=$cmslinks item=cmslink}
				{if $cmslink.meta_title != ''}
					<li>
						<a class="text-decoration-none" href="{$cmslink.link|escape:'html':'UTF-8'}" title="{$cmslink.meta_title|escape:'html':'UTF-8'}">
			...
			<li>
				<a class="text-decoration-none" href="{$link->getPageLink('sitemap')|escape:'html':'UTF-8'}" title="{l s='Sitemap' mod='blockcms'}">
