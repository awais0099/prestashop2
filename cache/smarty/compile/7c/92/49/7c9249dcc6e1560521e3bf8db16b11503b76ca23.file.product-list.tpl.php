<?php /* Smarty version Smarty-3.1.19, created on 2021-12-13 08:55:29
         compiled from "/var/www/html/prestashop2/themes/zayshop/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118169577161b750d1d02722-83808722%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '118169577161b750d1d02722-83808722',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61b750d1de8501_20398815',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61b750d1de8501_20398815')) {function content_61b750d1de8501_20398815($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/prestashop2/tools/smarty/plugins/function.math.php';
?>
...
" itemprop="url">
							<img style="border: none;" class="card-img-top replace-2x img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_default'), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
						<a class="h2 product-name text-left text-decoration-none" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" itemprop="url" style="">
					...
					<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['description'],80,'...');?>
